...
$login=mysql_query("SELECT * FROM   tbl_anggota WHERE BINARY nim='$nim' AND password='$pass' ");
...
$_SESSION[anggota]  = $r[id_agt];
 ...
 $tgl=date ('d/m/Y');
 $dt=date ('h:i A');
  mysql_query("UPDATE  tbl_anggota SET id_session='$sid_baru',tgl_log='$tgl',jam_log='$dt' WHERE nim='$nim'");
